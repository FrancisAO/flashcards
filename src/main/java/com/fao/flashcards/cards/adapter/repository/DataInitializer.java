...
public class DataInitializer {
        ...
        CommandLineRunner init(JpaCardSpringDataRepository cardRepository, JpaDeckSpringDataRepository deckRepository,
                        JpaDeckCardSpringDataRepository deckCardRepository) {
                return args -> {
                        ...
                        Card card2 = new Card("Was ist Spring Boot?",
                                        "Spring Boot ist ein Framework zur Erstellung von Java-Anwendungen");
                        card2.setTags(new HashSet<>(Arrays.asList("Programmierung", "Spring", "Java")));

                        Card card3 = new Card("Was ist React?",
                        ...
                        Card card4 = new Card("Was ist TypeScript?",
                        ...
                        // Decks erstellen
                        Deck deck1 = new Deck("Programmiersprachen",
                                        "Eine Sammlung von Karteikarten über verschiedene Programmiersprachen");
                        deck1.setTags(new HashSet<>(Arrays.asList("Programmierung", "Sprachen")));

                        Deck deck2 = new Deck("Frontend-Technologien",
                                        "Eine Sammlung von Karteikarten über Frontend-Technologien");
