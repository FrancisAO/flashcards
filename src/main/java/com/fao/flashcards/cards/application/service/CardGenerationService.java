...
public class CardGenerationService {
    ...
    private final AIGenerationRequestOutputPort generationRequestRepository;
    private final DocumentUploadOutputPort documentUploadRepository;
    private final AIGeneratedCardOutputPort generatedCardRepository;
    private final CardOutputPort cardRepository;
    ...
    public CardGenerationService(
            AIGenerationRequestOutputPort generationRequestRepository,
            DocumentUploadOutputPort documentUploadRepository,
            AIGeneratedCardOutputPort generatedCardRepository,
            CardOutputPort cardRepository,
