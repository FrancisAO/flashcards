...
public class OCRProcessResponse {
    ...
    public static OCRProcessResponse batchResult(List<OCRFileResult> results) {
        ...
        if (confidenceCount > 0) {
            ...
            avgConfidence = sum.divide(BigDecimal.valueOf(confidenceCount), 4, RoundingMode.HALF_UP);
        }
        ...
        String message = allSuccessful ? "Alle Dateien erfolgreich verarbeitet" : summary.getFormattedSummary();
