 ...
 */
@Repository
public interface JpaProjectFileSpringDataRepository extends JpaRepository<ProjectFile, String> {
       ...
       /**
        * Findet alle Dateien eines bestimmten Projekts nach Projekt-ID mit
        * Paginierung.
        */
