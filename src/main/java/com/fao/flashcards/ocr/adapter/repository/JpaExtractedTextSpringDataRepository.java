 ...
 */
@Repository
public interface JpaExtractedTextSpringDataRepository extends JpaRepository<ExtractedText, String> {
       ...
       List<ExtractedText> findByExtractionSourceIn(
                     @Param("extractionSources") List<ExtractionSource> extractionSources);
