...
import com.fao.flashcards.ocr.adapter.dto.DocumentChunk;
import com.fao.flashcards.ocr.adapter.dto.MistralOCRRequest;
import com.fao.flashcards.ocr.adapter.dto.MistralOCRResponse;
    ...
    private MistralOCRResponse callMistralAPI(MistralOCRRequest request) throws OCRProcessingException {
        try {
            ...
            if (e.getStatusCode() == HttpStatus.UNAUTHORIZED) {
                ...
                throw OCRProcessingException.apiError(e.getMessage(), e.getStatusCode().value());
            }
