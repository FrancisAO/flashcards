 ...
 * Bietet CRUD-Operationen und spezielle Abfragen für Performance-Metriken und
 * Status-Tracking.
 */
@Repository
public interface JpaOCRResultSpringDataRepository extends JpaRepository<OCRResult, String> {
